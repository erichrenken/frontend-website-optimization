...
var resizePizzas = function(size) {
  ...
  // Got rid of forced reflow by eliminating DOM calls from inside the for loop
...
// Removed the document.body.scrollTop calculation from the for loop as this doesn't need to be calculated each time.
...
// Changed the number of pizzas being created from 200 to 40 as there are only ever five rows of eight pizzas even on higher resolution monitors
